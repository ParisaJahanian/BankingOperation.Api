...
{
    public class PayaReqLogEntityConfiguration :IEntityTypeConfiguration<PayaReqLog>
    {
        public void Configure(EntityTypeBuilder<PayaReqLog> builder)
        {
            builder.ToTable("PayaTransfer_LOG_REQ");
